				...
				<div class="col-md-6">
                            ...
                            <div class="row">
								...
								<div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="req[0][category]" id="category" class="form-control" value="<?php echo $category;?>" required="" >
...
$('#submit_btn').click(function(){
	...
	var hir_date_from = jQuery('#hir_date_from').val();
    var hir_date_to = jQuery('#hir_date_to').val();
	
    var provider = jQuery('#provider').val();
	var pro_provider = jQuery('#pro_provider').val();
	var job = jQuery('#job').val();
	 var category = jQuery('#category').val();
	 var pro_category = jQuery('#pro_category').val();
	var resource_no = jQuery('#resource_no').val(); 
	var pro_resource_no = jQuery('#pro_resource_no').val(); 
	 var date_from = jQuery('#pro_date_from').val();
	var date_to = jQuery('#pro_date_to').val();
	 // var date_from1 = jQuery('#pro_date_from').val();
	// var date_to1= jQuery('#pro_date_to').val();
	 ...
	 $('#req_add_btn').click(function () {
        ...
        $('.experience_div').append(
			    ...
			    + '</div>'
				 + '<div class="form-group col-md-6">'
                + ' <label for="username">Job Category: </label>'
                + '<input type="text" name="req[' + req_increment + '][category]" id="pro_category" class="form-control repeatz" value="<?php echo $category;?>" required="" >'
                + '</div>'
				 + '</div>'
				 +   '<div class="row">'
                + '<div class="form-group col-md-6">'
                + ' <label for="username">Provider name: </label>'
                + '<input type="text" name="req[' + req_increment + '][provider]" id="pro_provider" class="form-control repeatz" required="" >'
                                    
                + '</div>'
                + '<div class="form-group col-md-6">'
                + ' <label for="username">No:of Resources: </label>'
                + '<input type="text"  name="req[' + req_increment + '][resource_no]"  class="form-control repeatz"  data-parsley-type="digits" id="pro_resource_no" data-parsley-trigger="change" required="" > '
			    + '</div>'
				 + '</div>'
				  +   '<div class="row">'
                ...
                + '<div class="col-md-6">'
                + '<label for="username">Date From: </label>'
               + '<input type="text" name="req[' + req_increment + '][date_from]" id="pro_date_from" class="form-control date_pickf repeatz" onkeydown="return false" required=""/>'
				+ '</div>'
                 + '<div class="col-md-6 ">'
                + '<label for="username">Date To: </label>'
				+ '<input type="text" name="req[' + req_increment + '][date_to]"  id="pro_date_to" class="form-control date_pick repeatz" onkeydown="return false"required="" />'
				+ '</div>'
				  + '</div>'
				  );
