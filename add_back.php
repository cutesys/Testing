               ...
               <ul class="nav nav-tabs nav-justified">
                    ...
                    <div class="tab-pane" id="tab1">
				        ...
				        <div class="col-md-6">
                                                            ...
                                                            <input type='text' name="hir_date_from" id="hir_date_from"
                                                                   ...
                                                                   class="form-control " value="<?php echo $hiring_requirment_date_from;?>" readonly=""/>
				...
				<div class="col-md-6">
                                                            ...
                                                            <input type='text' name="hir_date_to" id="hir_date_to"
                                                                   ...
                                                                   class="form-control" value="<?php echo $hiring_requirment_date_to;?>" readonly=""/>
	 ...
	 $('#req_add_btn').click(function () {
        ...
        $('.experience_div').append(
               ...
               // + '<input type="text" name="experience[' + experience_increment + '][experience_from]" class="form-control date_pick"/>'
				...
				+ '<input type="text" name="req[' + req_increment + '][date_from]" id="pro_date_from'+ req_increment +'" class="form-control date_pickf repeatz" onkeydown="return false" required=""/>'
