...
$type_list = $db->selectQuery("SELECT * FROM  sm_hiring_requirment WHERE `status` = '1'");
...
<section id="content">
    ...
    <div class="page page-shop-products">
        ...
        <div class="pageheader">
            ...
            <h2> Requirement List<span></span></h2>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong> </strong>Requirement Type List</h1>
                            <ul class="controls">
