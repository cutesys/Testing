<?php
$success_msg="";
$page = "hiring_requirment";
$tab = "";
$sub = "hiring_requirment_list";
$sub1 = "";
                                    ...
                                    <select  name="req[<?php echo $cd; ?>][job]" data-parsley-trigger="change"
                                        ...
                                        if (count($select_job) > 0) {
                                            for ($ji = 0; $ji < count($select_job); $ji++) {
                                                ?>
                                                <option
                                                    value="<?php echo $select_job[$ji]['job_name']; ?>"<?php if (($select_job[$ji]['job_name']) == $job) { ?> selected=""<?php } ?>><?php echo $select_job[$ji]['job_name']; ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
