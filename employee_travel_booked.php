      ...
      var t=  $('#products-list').DataTable({
            ...
            "columns": [
                ...
                
                {
                    ...
                    return '<a href="employee_travel_booked_edit.php?employee_id=' + data + '" class="btn btn-xs btn-default mr-5"><i class="fa fa-pencil"></i> Edit</a> <a onclick="delete_id(' + data + ')" class="btn btn-xs btn-blue" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-times"></i>Cancel</a>';
