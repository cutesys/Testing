...
$date_assign_to1=$date_assign_to[2]."-".$date_assign_to[1]."-".$date_assign_to[0];
	...
	$values["issued_date_to"] = $date_assign_to1;
	 $check_id = $db->selectQuery("select * from sm_employee_work_assign where issued_date_from='$date_assign_from1' and issued_date_to='$date_assign_to1'");
	 $employee_check_id = $db->selectQuery("select * from sm_employee_work_assign where issued_date_from='$date_assign_from1' and issued_date_to='$date_assign_to1'");
    ...
    if (count($check_id)) {
        ...
        $result = array("Status" => "already exists..", "data_val" => "0");
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
                ...
                <div class="tab-content">
                            ...
                            <div class="row">
								<div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="work_site_id" id="work_site_id" required=""><span id="exist_status" class="validate_span"></span>
                                        ...
                                        <?php
                                        $manuf = $db->selectQuery("SELECT `work_site`,`id` FROM `sm_work_site`where `status`='active'");
                                        if (count($manuf) > 0) {
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="date_assign_from" id="date_assign_from" class="form-control" />
				...
				<div class="row">
                    <div class="form-group col-md-6">
						...
						<div class='input-group datepicker' data-format="L">
                        <input type="text" name="date_assign_to" id="date_assign_to" class="form-control"/>
						<span class="input-group-addon"> <span class="fa fa-calendar"></span> 
                    </div>
					</div>
					<div class="col-md-6">
...
<script>
    ...
    $('#designation_id').change(function () {
        ...
        $.ajax({
            url: "emp_work_assign_add_ajax1.php",
            type: "POST",
    ...
    $('#date_assign_to').on('blur', function (e) {
