            ...
            "columns": [
				...
				
				{
					...
					"render": function (data) {
                        return '<a onclick="delete_id(' + data + ')" class="btn btn-xs btn-red" data-toggle="modal" data-target="#splashdel" data-options="splash-ef-3">Delete</a><a onclick="edit_id(' + data + ')" class="btn btn-xs btn-blue" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"><i class="fa fa-plus"></i>Edit</a><a onclick="delete_id(' + data + ')" class="btn btn-xs btn-default mr-5" data-toggle="modal" data-target="#uploadsplash" data-options="splash-ef-3">Upload</a>';
                }}
