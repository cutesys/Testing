...
AS employee_name,sm_employee.employee_employment_id,sm_employee.employee_id,sm_employee_performance.rating FROM sm_employee
 LEFT JOIN sm_employee_performance ON sm_employee.employee_id=sm_employee_performance.employee_id  WHERE  `employee_status`='1' AND `status`='active' AND sm_employee_performance.employee_id='$id'");
if (count($resFet)) {
