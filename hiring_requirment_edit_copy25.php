...
/*	$type_list = $db->selectQuery("SELECT * FROM sm_hiring_req_add WHERE hiring_requirment_id='$id' AND `status` = '1' ");
	if (count($type_list )) {
               ...
               <ul class="nav nav-tabs nav-justified">
                    ...
                    <div class="tab-pane" id="tab1">
				        ...
				        <div class="col-md-6">
                                                            ...
                                                            <input type='text' name="date_from"
                                                                   ...
                                                                   class="form-control date_pick" value="<?php echo $From;?>" readonly=""/>
				...
				<div class="col-md-6">
                                                            ...
                                                            <input type='text' name="date_to"
                                                                   ...
                                                                   class="form-control date_pick" value="<?php echo $To;?>" readonly=""/>

                                                        </div>
			</div>
						  <?php
                                                $job_provider= $db->selectQuery("SELECT * FROM `sm_hiring_req_add` WHERE `hiring_requirment_id`='$type_id' AND status='1'");
                                                $cd = 0;
						  ...
						  <!----  -->
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="req[<?php echo $cd; ?>][provider]" id="provider" class="form-control" required="" value="<?php echo $provider; ?>">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select  name="req[<?php echo $cd; ?>][job]" data-parsley-trigger="change"
                                        ...
                                        $select_job = $db->secure_select("SELECT `job` FROM `sm_hiring_req_add` WHERE `hiring_requirment_id`='$type_id' AND status='1'");

                                        if (count($select_job) > 0) {
                                            for ($ji = 0; $ji < count($select_job); $ji++) {
                                                ?>
                                                <option
                                                    value="<?php echo $select_job[$ji]['job']; ?>"<?php if (($select_job[$ji]['job']) == $job) { ?> selected=""<?php } ?>><?php echo $select_job[$ji]['job']; ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
								...
								<div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="req[<?php echo $cd; ?>][category]" id="category" class="form-control" required="" value="<?php echo $category; ?>">
                                   
                                </div>
								<div class="form-group col-md-6">
                                    <label for="username">No:of Resources: </label>
                                    <input type="text" name="req[<?php echo $cd; ?>][resource_no]" id="resource_no"  data-parsley-type="digits"class="form-control" required="" value="<?php echo $resource_no; ?>">
				        ...
				        <div class="col-md-6">
                                                            ...
                                                            <input type='text' name="req[0][date_from]"
                                                                   ...
                                                                   class="form-control date_pick"  value="<?php echo $date_from; ?>"/>
				...
				<div class="col-md-6">
                                                            ...
                                                            <input type='text' name="req[0][date_to]"
                                                                   ...
                                                                   class="form-control date_pick" value="<?php echo $date_to; ?>"/>
