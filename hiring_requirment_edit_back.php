...
<section id="content">
    ...
    <div class="page page-forms-wizard">
        ...
        <div class="pageheader">
            <h2>Edit Hiring Requirement<span></span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
					...
					<li>
                        <a href="javascript:void(0)">Edit Requirement</a>
                    </li>
        ...
        <div class="pagecontent">
            ...
            <div id="rootwizard" class="tab-container tab-wizard">
               <ul class="nav nav-tabs nav-justified">
                    <li><a href="#tab1" data-toggle="tab">Edit Requirement </a></li>
						...
						<input type="hidden" name="edit_id" value="<?php echo $_GET['type_id']; ?>" />
							<div class="row">
                                <div class="form-group col-md-6">
                                    <label for="username">Requirement: </label>
				...
				<div class="col-md-6">
				        ...
				        <div class="col-md-6">
                                                            ...
                                                            <input type='text' name="req[<?php echo $cd; ?>][date_from]"
                                                                   ...
                                                                   class="form-control date_pick"  value="<?php echo $exp_date_from; ?>"/>
				...
				<div class="col-md-6">
                                                            ...
                                                            <input type='text' name="req[<?php echo $cd; ?>][date_to]"
                                                                   ...
                                                                   class="form-control date_pick" value="<?php echo $exp_date_to; ?>"/>
