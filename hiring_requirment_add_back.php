				...
				<div class="col-md-6">
				        ...
				        <div class="col-md-6">
                                                            ...
                                                            <input type='text' name="req[0][date_from]" id="pro_date_from"
                                                                   ...
                                                                   class="form-control date_pick " required="" />
	...
	<script>
	 $('#req_add_btn').click(function () {
        ...
        $('.experience_div').append(
                ...
                + '<div class="form-group col-md-6">'
                + ' <label for="username">No:of Resources: </label>'
                + '<input type="text"  name="req[' + req_increment + '][resource_no]"  class="form-control repeatz"  data-parsley-type="digits" id="resource_no" data-parsley-trigger="change" required="" > '
			    + '</div>'
				 + '</div>'
				  +   '<div class="row">'
