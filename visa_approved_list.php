                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <ul class="controls">
							<li>
							 <a href="visa_type_add.php" role="button" tabindex="0" class="tile-add" title="add">
            ...
            "columns": [
               ...
               
                {
                    ...
                    "render": function (data) {
                        return '<a onclick="update_id(' + data + ')" class="btn btn-xs btn-green" data-toggle="modal" data-target="#splash" data-options="splash-ef-3"> Notify</a>';
