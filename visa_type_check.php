...
if (isset($_POST['type_name'])) {
    ...
    $result = array();
    $check_id = $db->selectQuery("select * from sm_visa_type where visa_type_name='$type_name' and visa_type_days='$type_days' and visa_type_status='1'");
    if (count($check_id)) {
		...
		$values["visa_type_days"] = $type_days;
