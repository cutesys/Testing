                ...
                <div class="tab-content">
                    <div class="tab-pane" id="tab1">
                        ...
                        <form name="step1" id="form1" role="form" method="post">
                                    ...
                                    <select class="form-control mb-10" name="category_job" id="category_job" required="">
                                        <option  value="">Select</option>
                                        <?php
                                        $select = $db->selectQuery("select * from sm_job_positions ");
                                        if (count($select)) {
...
$('#submit_btn').click(function(){
	...
	var category_job = jQuery('#category_job').val();
    if(category_name==""){
       // $('#exist_status').html("This value is required.");
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: {category_name: category_name,category_job: category_job},
